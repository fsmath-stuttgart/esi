...
und die Lehramtsstudenten nach GymPO über das LSF
...
da das System gerade in eurem ersten Semester
von der Uni Stuttgart das erste mal genutzt wird.
...
\subsubsection{Prüfungsvorbereitung}

Um eine Prüfung mit Erfolg absolvieren zu können,
gehört etwas mehr dazu, als Skripte auswendig zu lernen
und an Aufgaben zu knobeln.
Schließlich musst du in einer Prüfung
dann alles unter Zeitdruck, Prüfungspanik, etc.\ beherrschen.
Wenn du etwas richtig gescheit lernen willst,
empfehlen wir dir, dich an folgendem Zyklus zu orientieren:
\begin{enumerate}
\item
Einen Teil des Vorlesungsstoffs verinnerlichen...
\item
Den Stoff zum Vergleich in ein oder zwei Lehrbüchern nachlesen...
\item
Dazu passende Aufgaben bearbeiten, wenn nötig mit Notizblock...
\item
Lösung aufschreiben...
\item
Penibel auf Denkfehler, formale Fehler, Schreibfehler prüfen,
bis du eine perfekte Reinschrift hast...
\item
Vortragen der Lösung in der Lerngruppe an einer Tafel
oder irgendwie improvisiert...
\end{enumerate}
Keine Frage. Für die meisten ist es utopisch,
sämtlichen Stoff für die Prüfung
jedes mal nach diesem Zyklus zu durchlaufen,
aufgrund des Zeitaufwands.
Doch es lohnt sich, zumindest ein paar mal
für besonders wichtige Abschnitte
diesen Zyklus komplett zu durchlaufen.
Das hilft zu überprüfen,
ob du beim Lernen wirklich sachlich
und präzise vorgegangen bist.
Es ist auch abwechslungsreicher und befriedigender
als einfach nur massenhaft Stoff aufzusaugen
und dann gleich wieder zu vergessen.

Im (unrealistischen) Optimalfall hast du das natürlich
schon während der Vorlesungszeit parallel zur Übungsgruppe
mit jeder Aufgabe durchexerziert
und musst dann vor der Prüfung nur noch auffrischen.
In anbetracht der Stoffmenge einer durchschnittlichen Vorlesung
wirst du meistens abwägen müssen,
wie oft und wie weit du diesen Zyklus vollständig durchläufst.
...
daß dieses in der Regel nur bis zum Ende
...
1. {\bf Die Mathematik-Homepage:}\\
{\verb|http://www.mathematik.uni-stuttgart.de/fachbereich/kvv/kvvi|}\\
Auch erreichbar über \glqq Studium\grqq\ $\Rightarrow$
\glqq Vorlesungen\grqq\ $\Rightarrow$ \glqq Mathematik Studiengänge\grqq.
Etwas früher werden gibt es schon bei \glqq Studium\grqq\ 
$\Rightarrow$ \glqq Vorlesungsplanung\grqq\ 
einen kurzen Überblick über das Angebot:\\
{\small
\verb|http://www.mathematik.uni-stuttgart.de/fachbereich/studium/vorlesungsplanung/index.html|}

2. {\bf Das LSF-Portal:}\\
{\verb|lsf.uni-stuttgart.de|}\\
Links in der Menüleiste auf \glqq Vorlesungsverzeichnis\grqq\ klicken,
...
Der Studiendekan für den  Bachelor ist
Herr Prof. Dr. Uwe Semmelmann\\
Zimmer: 7.544\\
Telefon (0711) 685 - 65334\\
E-Mail:  uwe.semmelmann@mathematik.uni-stuttgart.de
